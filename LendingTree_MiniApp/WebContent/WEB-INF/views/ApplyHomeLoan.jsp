...
<form:form method="POST" action="homeloansave.html">
     <center>
 ...
 <tr><td><h4>BASIC DETAILS</h4></td></tr>
	...
	<tr>
		...
		<tr>
			...
			<td><form:input path="dateofbirth" class="easyui-datebox"  style="width:100%;"></form:input></td>
			<td ><form:errors path="dateofbirth" cssClass="error"></form:errors></td>
		</tr>
		<tr>
			<td>Marrital Status</td>
			
			<td><form:radiobutton path="maritalstatus" value="sinle"/>Single
	...
	<tr>
		...
		<td><form:input path="educationqualification"/></td>
...
<td ><form:errors path="address" cssClass="error"></form:errors></td></tr>
     <tr><td>Country</td>
		...
		<td><form:select path="country" id="country" cssStyle="textbx;width:173px"  onchange="getStates(this.value);">
     ...
     <tr>  
      		...
      		<td><form:select path="state" id="state"   cssStyle="textbx;width:173px" cssClass="textbx">
...
<tr><td><h4>PROFESSION/OCCUPATION</h4></td>
<td></td>
...
<tr><td><form:radiobutton path="occupation" id="s" value="Salaried"/><b>SALARIED</b></td></tr>
	...
	<tr><td>Address</td>
<td><form:textarea path="ofcaddress" style="width:166px"></form:textarea></td>
...
<tr><td><h4>PROPERTY DETAILS</h4></td></tr>
	...
	<tr>
		<td>Builder Name</td>
		<td><form:input path="buildername"/></td>
	...
	<tr>
		...
		<td><form:input path="builtuparea"/></td>
	...
	<tr>
		...
		<td><form:input path="sellercontactno"/></td>
		<td><form:errors path="sellercontactno" cssClass="error"></form:errors></td>
	</tr>
	
 		<tr><td>Seller Address</td>
<td><form:textarea path="selleraddress" style="width:166px"></form:textarea></td>
...
<tr><td><h4>LOAN DETAILS</h4></td></tr>
	...
	<tr>
		...
		<td><form:input path="propertycost"/></td>
	...
	<tr>
		<td>Bank Type</td>
		<td><form:select path="banktype" style="width:173px"  onclick="displayBank();" onchange="displayInterest();" id="bankdisplay">
