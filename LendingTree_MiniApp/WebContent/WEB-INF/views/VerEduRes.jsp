...
<form:form method="POST" action="vereloanresponsesave.html">
     <center>
   ...
   <tr><td><h4>BASIC DETAILS</h4></td></tr>
	...
	<tr>
		...
		<tr>
			...
			<td><form:input path="dateofbirth"  readonly="true" class="easyui-datebox"  style="width:60%;"></form:input></td>
...
<td ><form:errors path="address" cssClass="error"></form:errors></td></tr>
     <tr><td>Country</td>
		...
		<td><form:select path="country"  readonly="true" id="country" cssStyle="textbx;width:173px"  onchange="getStates(this.value);">
     ...
     <tr>  
      		...
      		<td><form:select path="state"  readonly="true"  id="state"   cssStyle="textbx;width:173px" cssClass="textbx">
...
<tr><td><h4>COURSE DETAILS</h4></td></tr>


	<tr>
			<td>Admission Status</td>
		
			<td><form:radiobutton path="admissionstatus"  readonly="true" value="Conformed"/>Conformed
				<form:radiobutton path="admissionstatus" value="Awaited"/>Awaited
				
			</td>
			<td><form:errors path="admissionstatus" cssClass="error"></form:errors></td>
		</tr>
	<tr>
		<td>University/College</td>
		<td><form:input path="university"  readonly="true"/></td>
		<td><form:errors path="university" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Office Email</td>
		<td><form:input path="namecourse"  readonly="true"/></td>
		<td><form:errors path="namecourse" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Office Contact</td>
		<td><form:input path="courseduration"  readonly="true"/></td>
		<td><form:errors path="courseduration" cssClass="error"></form:errors></td>
	</tr>
	<tr>
			<td>Admission Status</td>
			
			<td><form:radiobutton path="coursetype"  readonly="true" value="Fulltime"/>Full Time
				<form:radiobutton path="coursetype" value="Parttime"/>Part Time
				<form:radiobutton path="coursetype" value="Distancelearning"/>Distance Learning
				
			</td>
			<td><form:errors path="coursetype" cssClass="error"></form:errors></td>
		</tr>
	<tr><td>College Address</td>
<td><form:textarea path="collegeaddress"  readonly="true" style="width:166px"></form:textarea></td>
<td ><form:errors path="collegeaddress" cssClass="error"></form:errors></td></tr>
...
<tr>
			<td>Last Education Marks Sheet</td>
		
			<td><form:radiobutton path="marksheet" value="yes"/>Yes
				<form:radiobutton path="marksheet" value="no"/>No
				
			</td>
			<td><form:errors path="marksheet" cssClass="error"></form:errors></td>
		</tr>
<tr>
<tr>
			<td>Admission Proof</td>
		
			<td><form:radiobutton path="admisssionproof" value="yes"/>Yes
				<form:radiobutton path="admisssionproof" value="no"/>No
				
			</td>
			<td><form:errors path="admisssionproof" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Rank Copy</td>
		
			<td><form:radiobutton path="rankcopy" value="yes"/>Yes
				<form:radiobutton path="rankcopy" value="no"/>No
				
			</td>
			<td><form:errors path="rankcopy" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Scholarship Copy</td>
		
			<td><form:radiobutton path="scholarshipcopy" value="yes"/>Yes
				<form:radiobutton path="scholarshipcopy" value="no"/>No
				
			</td>
			<td><form:errors path="scholarshipcopy" cssClass="error"></form:errors></td>
		</tr>
		<tr>
			<td>Pan Card</td>
