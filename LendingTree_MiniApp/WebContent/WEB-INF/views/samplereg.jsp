...
<form:form method="POST" action="registrationsuccess.html">
      ...
      <tr>	   		
	   		<td> Middle Name:</td>
	   		<td><form:input path="middlename" placeholder="" /></td>
	   		...
	   		<tr><td> User Name:</td>
	   		<td><form:input path="username"  styleId="username" placeholder="" onchange="unique()" /></td>
	   		
	   		<td><span id = "susername" style="color:red"></span><form:errors path="username" cssClass="error"  />
	   		...
	   		<tr>
			        <td> Password:</td>
			        <td><form:password path="password" style="width:140px" placeholder="" /></td>
			        <td><form:errors path="password" cssClass="error" /></td>
			    </tr>
			    <tr>
			        <td> ConfirmPassword:</td>
			        <td><form:password path="conformpassword" style="width:140px" placeholder="" /></td>
			        <td><form:errors path="conformpassword" cssClass="error" /></td>
			    </tr>
	   		 <tr>
			        <td>Gender:</td>
			        <td><form:radiobutton path="gender" value="male" placeholder="" />Male
      ...
      <td>Country :</td>  
      <td>
      <form:select path="country" styleid="country" style="width:145px"></form:select>
     ...
     <td><form:errors path="country" cssClass="error" /></td>
       ...
       <tr><td>Country  :</td>
		<td><form:select path="country" id="country" cssStyle="textbx;width:150px"  onchange="getStates(this.value);">
     ...
     <tr>  
      <td>State :</td> 
      	...
      	<td><form:select path="state" id="state"   cssStyle="textbx;width:150px" cssClass="textbx">
		<option value="">select state</option>
		</form:select></td>
		<td><form:errors path="state" cssClass="error" /></td>
     	</tr> 
    <%--  <td><form:select path="state" styleid="state" style="width:145px"></form:select>
     ...
     <tr>
	   		...
	   		<tr>
	   		<td> Address:</td>
	   		<td><form:textarea path="address" style="width:140px"/></td>
	   		...
	   		<td><form:checkbox path="language" id = "t" value="Telugu"/>Telugu
	   		<form:checkbox path="language" id="e" value="English"/>English
	   		<form:checkbox path="language" id="h" value="Hindi"/>Hindi
	   		</td>
