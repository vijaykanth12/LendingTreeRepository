...
<title>Messages Management Page</title>
<meta charset="UTF-8">
...
<script>
	function add()
	{
		window.location.href="composeadmin.html";
	}  
</script> 
<script>
	function update()
...
<center>			 <!-- <h2><font  color="red">Bank Management is under Maintenance</font></h2>
 ...
 <table id="dg" class="easyui-datagrid" title="Inbox" style="width:700px;height:200px"
    	
          multiSelect="true"  rownumbers="true" pagination="true" fitColumns="false" data-options="multiSelect:true,url:'adminmsggrid.html',onDblClickRow:function(index,row){update()},method:'get'">
        <thead> 
        
	           <tr>
	             <th align="center" data-options="field:'fromu',width:100">From</th>
                <th align="center" data-options="field:'regid',width:100">User Id</th>
...
<div style="margin:20px 0;"  align="center"> 
        ...
        <input type="button" name="Compose" value="Compose" onclick="add()" class="button">&nbsp;&nbsp;&nbsp; 
