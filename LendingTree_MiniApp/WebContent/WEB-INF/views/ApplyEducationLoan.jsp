...
<form:form method="POST" action="educationloansave.html">
     <center>
	...
	<tr>
		...
		<tr>
			...
			<td><form:input path="dateofbirth" class="easyui-datebox"  style="width:60%;"></form:input></td>
...
<tr><td><h4>COURSE DETAILS</h4></td></tr>
	...
	<tr>
			...
			<td><form:radiobutton path="admissionstatus" value="Conformed"/>Conformed
	...
	<tr>
			...
			<td><form:radiobutton path="coursetype" value="Fulltime"/>Full Time
...
<td><form:textarea path="collegeaddress" style="width:166px"></form:textarea></td>
