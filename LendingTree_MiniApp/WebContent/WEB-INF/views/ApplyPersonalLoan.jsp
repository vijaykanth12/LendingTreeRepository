...
<form:form method="POST" action="personalloansave.html">
     <center>
    
     <h2>Apply Personal Loan</h2>
...
<tr><td><h4>PRESENT ADDRESS DETAILS</h4></td></tr>
 	...
 	<tr><td>Address</td>
<td><form:textarea path="address" style="width:167px"></form:textarea></td>
<td ><form:errors path="address" cssClass="error"></form:errors></td></tr>
     <tr><td>Country</td>
    
		<td><form:select path="country" id="country" cssStyle="textbx;width:174px"  onchange="getStates(this.value);">
     ...
     <tr>  
      		...
      		<td><form:select path="state" id="state"   cssStyle="textbx;width:174px" cssClass="textbx">
...
<tr><td><h4>PROFESSION/BUSINESS/OCCUPATION</h4></td>
<td></td>
<td><form:errors path="occupation" cssClass="error"></form:errors></td></tr>
<tr><td><form:radiobutton path="occupation" id="s" value="Salaried"/><b>SALARIED</b></td>
</tr>
...
<td><form:textarea path="ofcaddress" style="width:167px"></form:textarea></td>
...
<tr><td><h4>LOAN DETAILS</h4></td></tr>
	...
	<tr>
		<td>Tenture Required(In Months)</td>
	...
	<tr>
		<td>Bank Type</td>
		<td><form:select path="banktype" style="width:174px"  onclick="displayBank();" onchange="displayInterest();" id="bankdisplay">
