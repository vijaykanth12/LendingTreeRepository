   ...
   function displayBank()
  {
	...
	$.ajax({
	    ...
	    success: function(response){
	      	...
	      	/* 	var pl=document.getElementById("bankdisplay").valueOf();
	...
	$.ajax({
	    ...
	    url: 'bankemps.html',   
	  	success: function(response){
	      		...
	      		var k=response.split(",");
	      	/* 	var pl=document.getElementById("emps").valueOf();
	      	    for(var j=0;j<=k.length+1;j++)
	      		{
	      		   var option=document.createElement("option");
	      		   option.text=pl[j];
...
<form:form method="POST" action="hloanresponsesave.html">
     <center>
	...
	<tr>
		...
		<tr>
			...
			<td><form:radiobutton path="gender" value="male" readonly="true"/>Male
		...
		<tr>
			...
			<td><form:input path="dateofbirth" class="easyui-datebox"  style="width:100%;" readonly="true"></form:input></td>
			<td ><form:errors path="dateofbirth" cssClass="error"></form:errors></td>
		</tr>
		<tr>
			<td>Marrital Status</td>
		
			<td><form:radiobutton path="maritalstatus" value="sinle" readonly="true"/>Single
				<form:radiobutton path="maritalstatus" value="married" readonly="true"/>Married
...
<tr><td><h4>PRESENT ADDRESS DETAILS</h4></td></tr>
 		...
 		<tr><td>Address</td>
<td><form:textarea path="address" style="width:166px" readonly="true"></form:textarea></td>
<td ><form:errors path="address" cssClass="error"></form:errors></td></tr>
     <tr><td>Country</td>
    
		<td><form:select path="country" id="country" cssStyle="textbx;width:173px"  onchange="getStates(this.value);" readonly="true">
     ...
     <tr>  
      		...
      		<td><form:select path="state" id="state"   cssStyle="textbx;width:173px" cssClass="textbx" readonly="true">
...
<tr><td><form:radiobutton path="occupation" id="s" value="Salaried" readonly="true"/><b>SALARIED</b></td></tr>
	...
	<tr>
		...
		<td><form:errors path="ofccontact" cssClass="error"></form:errors></td>
 		...
 		<tr><td>Address</td>
<td><form:textarea path="ofcaddress" style="width:166px" readonly="true"></form:textarea></td>
<td ><form:errors path="ofcaddress" cssClass="error"></form:errors></td></tr>

<tr><td><form:radiobutton path="occupation" id="self" value="Self Employed" readonly="true"/><b>SELF EMPLOYED</b></td></tr>
...
<td><form:textarea path="selleraddress" style="width:166px" readonly="true"></form:textarea></td>
...
<tr>
			<td>Assign To</td>
			<td><form:select path="assignedto" style="width:173px" onclick="displayEmps();" id="emps">
				<option value="">Select Option</option>
				
			</form:select>
			</td>
			<td><form:errors path="assignedto" cssClass="error"></form:errors></td>
		</tr>
		<tr>
