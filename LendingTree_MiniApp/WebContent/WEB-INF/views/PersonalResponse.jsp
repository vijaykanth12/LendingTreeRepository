...
<form:form method="POST" action="ploanresponsesave.html">
     <center>
...
<td ><form:errors path="address" cssClass="error"></form:errors></td></tr>
     <tr><td>Country</td>
		...
		<td><form:select path="country"  readonly="true" id="country" cssStyle="textbx;width:174px"  onchange="getStates(this.value);">
     ...
     <tr>  
      		...
      		<td><form:select path="state" id="state"  readonly="true" cssStyle="textbx;width:174px" cssClass="textbx">
...
<tr>
			<td>Status Type</td>
			<td><form:select path="status" style="width:174px" id="status">
...
<tr>
			<td>Assign To</td>
			<td><form:select path="assignedto" style="width:174px" onclick="displayEmps();" id="emps">
				<option value="">Select Option</option>
