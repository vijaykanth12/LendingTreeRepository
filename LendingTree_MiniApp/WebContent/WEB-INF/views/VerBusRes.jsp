...
<form:form method="POST" action="verbloanresponsesave.html">
     <center>
 ...
 <tr><td><h4>BASIC DETAILS</h4></td></tr>
	...
	<tr>
		...
		<tr>
			...
			<td><form:input path="dateofbirth" class="easyui-datebox" readonly="true" style="width:100%;"></form:input></td>
...
<td ><form:errors path="address" cssClass="error"></form:errors></td></tr>
     ...
     <td><form:errors path="country"  readonly="true" cssClass="error" /></td>
     </tr>
     <tr>  
      		<td>State</td> 
...
<tr><td><h4>DETAILS OF COMPANY</h4></td></tr>
	...
	<tr>
			...
			<td><form:radiobutton path="taxpaid" value="Yes"/>Yes
...
<tr>
			<td>Audited Finance</td>
		
			<td><form:radiobutton path="auditedfinance" value="yes"/>Yes
				<form:radiobutton path="auditedfinance" value="no"/>No
				
			</td>
			<td><form:errors path="auditedfinance" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Company Address Proof</td>
		
			<td><form:radiobutton path="comaddressproof" value="yes"/>Yes
				<form:radiobutton path="comaddressproof" value="no"/>No
				
			</td>
			<td><form:errors path="comaddressproof" cssClass="error"></form:errors></td>
		</tr>

<tr>
			<td>Company Profile</td>
		
			<td><form:radiobutton path="comprofile" value="yes"/>Yes
				<form:radiobutton path="comprofile" value="no"/>No
				
			</td>
			<td><form:errors path="comprofile" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Product Profile</td>
		
			<td><form:radiobutton path="productprofile" value="yes"/>Yes
				<form:radiobutton path="productprofile" value="no"/>No
				
			</td>
			<td><form:errors path="productprofile" cssClass="error"></form:errors></td>
		</tr>
<tr>
