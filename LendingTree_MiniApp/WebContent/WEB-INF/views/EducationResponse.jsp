...
<form:form method="POST" action="eloanresponsesave.html">
     <center>
   ...
   <tr><td><h4>BASIC DETAILS</h4></td></tr>
	...
	<tr>
		...
		<tr>
			...
			<td><form:input path="dateofbirth" class="easyui-datebox"  style="width:60%;" readonly="true" ></form:input></td>
...
<tr><td><h4>COURSE DETAILS</h4></td></tr>
	...
	<tr>
			...
			<td><form:radiobutton path="admissionstatus" value="Conformed" readonly="true"/>Conformed
	...
	<tr>
			...
			<td><form:radiobutton path="coursetype" value="Fulltime" readonly="true"/>Full Time
				<form:radiobutton path="coursetype" value="Parttime" readonly="true"/>Part Time
				<form:radiobutton path="coursetype" value="Distancelearning" readonly="true"/>Distance Learning
				
			</td>
			<td><form:errors path="coursetype" cssClass="error"></form:errors></td>
		</tr>
	<tr><td>College Address</td>
<td><form:textarea path="collegeaddress" style="width:166px" readonly="true"></form:textarea></td>
...
<tr>
			...
			<td><form:errors path="assignedto" cssClass="error"></form:errors></td></tr>
		<tr>
