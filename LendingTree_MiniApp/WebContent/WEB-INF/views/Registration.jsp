		...
		success:function(id)
		{
			...
			for(var i=0;i<d.length;i++)
			{
				...
				if(x == (d[i]))
				{
					...
					document.getElementById("usp").innerHTML="<b>Username is not Available<b>";
					document.getElementById("uname").value="";
				}
...
<body onload="languages();country();checkU();checkEU();">
...
<tr>
<td></td><td>Last name</td>
<td><form:input path="lastname"/></td>
<td ><form:errors path="lastname" cssClass="error"></form:errors></td></tr>
<tr>
<td></td><td>User name</td>
<td><form:input path="username" onchange="checkUser()" id="user"/></td>
<td ><form:errors path="username" cssClass="error"></form:errors></td>
<td><span style="color:red"  id="usp"/></span>
	...
	<td></td>
		...
		<td><form:password path="conformpassword"/></td>
...
<tr>
<tr>
<td></td><td>Date of birth</td>
<td><form:input path="dateofbirth" class="easyui-datebox"  style="width:96%;"></form:input></td>
<td ><form:errors path="dateofbirth" cssClass="error"></form:errors></td></tr>
<tr>
<td></td><td>Languages known</td>
