 ...
 function del()
  ...
  <script>
      	function refreshPage()
      	{
      		...
      		$('#dg').datagrid({url:'loanVDisplayGrid.html'});
...
<br> 
 <table id="dg" class="easyui-datagrid" title="Customers are" style="width:700px;height:250px"
          ...
          singleSelect="true"  rownumbers="true" pagination="true" fitColumns="false" data-options="singleSelect:true,url:'loanVDisplayGrid.html',onDblClickRow:function(index,row){update()},method:'get'">
        <thead> 
