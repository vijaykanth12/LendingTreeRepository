...
<form:form method="POST" action="businessloansave.html">
     <center>
    
     <h2>Apply Business Loan</h2>
...
<tr><td><h4>DETAILS OF COMPANY</h4></td></tr>
	...
	<tr>
			...
			<td><form:radiobutton path="legalstatus" value="Pvtltd"/>Pvt.Ltd
...
<td><form:textarea path="regofcaddress" style="width:166px"></form:textarea></td>
