...
<form:form method="POST" action="aaploanresponse.html">
     <center>
	...
	<tr>
		...
		<tr>
			...
			<td><form:radiobutton path="gender" readonly="true" value="male"/>Male
				...
				<form:radiobutton path="gender" value="thirdgender"/>Third Gender
			</td>
		...
		<tr>
			...
			<td><form:input path="dateofbirth" readonly="true" class="easyui-datebox" style="width:80%;"></form:input></td>
