...
<form:form method="POST" action="verploanresponsesave.html">
     <center>
    
     <h2> Personal Loan</h2>
   
     <table border="0" align="center">
	<tr><td><h4>BASIC DETAILS</h4>
	<tr>
...
<tr><td><form:radiobutton path="occupation"  readonly="true" id="s" value="Salaried"/><B>SALARIED</B></td></tr>
...
<tr>
	...
	<td><form:radiobutton path="occupation"  readonly="true" id="self" value="Self Employed"/><b>SELF EMPLOYED</b></td>
</tr>
...
<tr><td><h4>INCOME DETAILS</h4></td></tr>
	...
	<tr>
		<td>Interest Rate</td>
		<td><form:input path="interestrate"  readonly="true" id="interestrate"/></td>
...
<tr>
			...
			<td><form:radiobutton path="proofofidentity"  readonly="true" value="yes"/>Yes
...
<tr>
			...
			<td><form:radiobutton path="pandocument"  readonly="true"  value="yes"/>Yes
...
<tr>
			...
			<td><form:radiobutton path="bankstatement"  readonly="true" value="yes"/>Yes
...
<tr>
			...
			<td><form:radiobutton path="payslips"  readonly="true" value="yes"/>Yes
				<form:radiobutton path="payslips" value="no"/>No
				
			</td>
			<td><form:errors path="payslips" cssClass="error"></form:errors></td>
		</tr>
	<tr>
			<td>IT Returns</td>
		
			<td><form:radiobutton path="itreturns"  readonly="true" value="yes"/>Yes
				<form:radiobutton path="itreturns" value="no"/>No
			</td>
			<td><form:errors path="itreturns" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Address Prooff</td>
		
			<td><form:radiobutton path="addressprooff"  readonly="true" value="yes"/>Yes
...
<tr>
			...
			<td><form:radiobutton path="personalInquiry"  readonly="true" value="yes"/>Yes
...
<tr>
		...
		<tr>
			<td><form:hidden path="loanapplydate"/></td>
		</tr>
		<tr>
			<td></td>
