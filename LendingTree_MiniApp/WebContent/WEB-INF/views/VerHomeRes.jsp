...
<title>Home Response page</title>
...
<form:form method="POST" action="verhloanresponsesave.html">
     <center>
	...
	<tr>
		...
		<tr>
			...
			<td><form:errors path="gender"  readonly="true" cssClass="error"></form:errors></td>
		</tr>
		<tr>
			<td>Date of birth</td>
...
<tr><td><h4>PRESENT ADDRESS DETAILS</h4></td></tr>
...
<tr><td><h4>PROFESSION/OCCUPATION</h4></td></tr>
<tr><td><form:radiobutton path="occupation" id="s" value="Salaried"/><b>SALARIED</b></td></tr>
	...
	<tr>
		<td>Office Email</td>
		<td><form:input path="workemail"  readonly="true"/></td>
		<td><form:errors path="workemail" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Office Contact</td>
		<td><form:input path="ofccontact"  readonly="true"/></td>
		<td><form:errors path="ofccontact" cssClass="error"></form:errors></td>
	</tr>
	
 		<tr><td>Address</td>
<td><form:textarea path="ofcaddress"  readonly="true" style="width:166px"></form:textarea></td>
<td ><form:errors path="ofcaddress" cssClass="error"></form:errors></td></tr>

<tr><td><form:radiobutton path="occupation" id="self" value="Self Employed"/><b>SELF EMPLOYED</b></td></tr>

	<tr>
		<td>Firm</td>
		<td><form:input path="firm"  readonly="true"/></td>
		<td><form:errors path="firm" cssClass="error"></form:errors></td>
	</tr>	
	<tr>
		<td>Profession</td>
		<td><form:input path="profession"  readonly="true"/></td>
		<td><form:errors path="profession" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Nature of Business</td>
		<td><form:input path="natureofbusiness"  readonly="true"/></td>
		<td><form:errors path="natureofbusiness" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td> No. of years experience</td>
		<td><form:input path="noofexp"  readonly="true"/></td>
		<td><form:errors path="noofexp" cssClass="error"></form:errors></td>
	</tr>
...
<tr><td><h4>PROPERTY DETAILS</h4></td></tr>

	<tr>
		<td>Builder Name</td>
		<td><form:input path="buildername"  readonly="true"/></td>
		<td><form:errors path="buildername" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Building Name)</td>
		<td><form:input path="buildingname"  readonly="true"/></td>
		<td><form:errors path="buildingname" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Built up Area(Sq.ft)</td>
		<td><form:input path="builtuparea"  readonly="true"/></td>
		<td><form:errors path="builtuparea" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Seller Name</td>
		<td><form:input path="sellername"  readonly="true"/></td>
		<td><form:errors path="sellername" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Seller Contact No</td>
		<td><form:input path="sellercontactno"  readonly="true"/></td>
		<td><form:errors path="sellercontactno" cssClass="error"></form:errors></td>
	</tr>
	<tr><td>Seller Address</td>
<td><form:textarea path="selleraddress"  readonly="true" style="width:166px"></form:textarea></td>
<td ><form:errors path="selleraddress" cssClass="error"></form:errors></td></tr>
...
<tr><td><h4>LOAN DETAILS</h4></td></tr>
	...
	<tr>
		...
		<td><form:input path="propertycost"  readonly="true"/></td>
		<td><form:errors path="propertycost" cssClass="error"></form:errors></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><form:input path="purpose"  readonly="true"/></td>
		<td><form:errors path="purpose" cssClass="error"></form:errors></td>
	</tr>
	<tr>
		<td>Bank Type</td>
...
<tr><td><h4>VERIFIED CERTIFICATES ARE</h4></td></tr>
<tr>
			<td>Proof Of Identity</td>
		
			<td><form:radiobutton path="proofofidentity" value="yes"/>Yes
				<form:radiobutton path="proofofidentity" value="no"/>No
				
			</td>
			<td><form:errors path="proofofidentity" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Pan Card</td>
		
			<td><form:radiobutton path="pandocument" value="yes"/>Yes
				<form:radiobutton path="pandocument" value="no"/>No
				
			</td>
			<td><form:errors path="pandocument" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Bank Statement</td>
		
			<td><form:radiobutton path="bankstatement" value="yes"/>Yes
				<form:radiobutton path="bankstatement" value="no"/>No
				
			</td>
			<td><form:errors path="bankstatement" cssClass="error"></form:errors></td>
		</tr>
	<tr>
			<td>Residence Proof</td>
		
			<td><form:radiobutton path="residenceproof" value="yes"/>Yes
				<form:radiobutton path="residenceproof" value="no"/>No
				
			</td>
			<td><form:errors path="residenceproof" cssClass="error"></form:errors></td>
		</tr>
	<tr>
			<td>Property Tax</td>
		
			<td><form:radiobutton path="propertytax" value="yes"/>Yes
				<form:radiobutton path="propertytax" value="no"/>No
				
			</td>
			<td><form:errors path="propertytax" cssClass="error"></form:errors></td>
		</tr>

		
		
<tr>
			<td>Address Prooff</td>
		
			<td><form:radiobutton path="addressprooff" value="yes"/>Yes
				<form:radiobutton path="addressprooff" value="no"/>No
				
			</td>
			<td><form:errors path="addressprooff" cssClass="error"></form:errors></td>
		</tr>
<tr>
			<td>Personal Inquiry</td>
		
			<td><form:radiobutton path="personalInquiry" value="yes"/>Yes
				<form:radiobutton path="personalInquiry" value="no"/>No
				
			</td>
			<td><form:errors path="personalInquiry" cssClass="error"></form:errors></td>
		</tr>

<tr><td><h4>STATUS</h4></td></tr>
<tr>
			<td>Status Type</td>
