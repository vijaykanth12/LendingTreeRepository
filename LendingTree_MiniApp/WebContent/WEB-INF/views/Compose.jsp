...
<sec:authorize ifAllGranted="ROLE_ADMIN">
 <center>
<form:form method="post" action="composeadminsave.html">
...
<td ><form:errors path="regid" cssClass="error"></form:errors></td>
</tr>  
	

 
 <tr><td>To</td>
<td><form:input path="tou" value="User" readonly="true"/></td>
</tr>
<tr><td>Subject</td>
