...
<form:form method="POST" action="verificationsave.html">
     <center>
    
     <h2>Loan Verification</h2>
...
<td ><form:errors path="assignto" cssClass="error"></form:errors></td>
 ...
 <h3>Submitted Certificates</h3>
     <table border="0" align="center">
<tr>
	<td>3 Months Payslips</td>
	<td><form:checkbox path="payslips" value="Verified"/></td>
</tr>
<tr>
	<td>Offer Letter</td>
	<td><form:checkbox path="offerletter" value="Verified"/></td>
</tr>
<tr>
	<td>Company Details</td>
	<td><form:checkbox path="companydetails" value="Verified"/></td>
</tr>
<tr>
	<td>Address Proof</td>
	<td><form:checkbox path="addressproof" value="Verified"/></td>
</tr>

<tr>
	<td>Photo Identity</td>
	<td><form:checkbox path="photoidentity" value="Verified"/></td>
</tr>

<tr>
	<td>It Returns</td>
	<td><form:checkbox path="itreturns" value="Verified"/></td>
</tr>

<tr>
	<td>Pan	Card</td>
	<td><form:checkbox path="pancard" value="Verified"/></td>
</tr>

<tr>
	<td>Personal Inquiry</td>
	<td><form:checkbox path="personalenquiry" value="Verified"/></td>
</tr>

<tr>
			<td>Status Type</td>
			<td><form:select path="statustype" style="width:150px">
