...
<script type="text/javascript"  src="views/countries.js"></script>
   ...
   function getStates(country)
{
 ...
 var langs='${command.languagesknown}';
 var langarray=langs.split(",");
 var value1=document.getElementById("t").value;			  
 var value2=document.getElementById("h").value;	
 var value3=document.getElementById("e").value;	

 
 for(var i=0;i<langarray.length;i++)
	{
		
		if(value1==langarray[i])
			document.getElementById("t").checked=true;						
		else if(value2==langarray[i])
			document.getElementById("h").checked=true;
		else if(value3==langarray[i])
...
<body onload="languages();country();">
<sec:authorize ifAllGranted="ROLE_USER">
<form:form method="GET" action="usersaveupdate.html">
...
<tr><td>First name</td>
	<td><form:input path="firstname" value="${stds.firstname}" /></td>
	<td><form:errors path="firstname" cssClass="error"></form:errors></td></tr>
<tr><td>Middle name</td>
<td><form:input path="middlename" value="${stds.middlename}"/></td>
<td><form:errors path="middlename" cssClass="error"></form:errors></td></tr>
<tr><td>Last name</td>
<td><form:input path="lastname" value="${stds.lastname}"/></td>
<td><form:errors path="lastname" cssClass="error"></form:errors></td></tr>
<tr>
	<td>User name</td>
	<td><form:input path="username" value="${stds.username}" readonly="true"/></td>
	<td><form:errors path="username" cssClass="error"></form:errors></td></tr>
<tr>
...
<tr><td>Email id</td>
<td><form:input path="emailid" value="${stds.emailid}"/></td>
<td><form:errors path="emailid" cssClass="error"></form:errors></td></tr>
<tr><td>Mobile</td>
<td><form:input path="mobile" value="${stds.mobile}"/></td>
...
<td><form:input path="dateofbirth" class="easyui-datebox"  style="width:96%;" value="${stds.dateofbirth}"/></td>
<td><form:errors path="dateofbirth" cssClass="error"></form:errors></td></tr>
<tr><td>Languages known</td>
<td><form:checkbox path="languagesknown" id="e" value="English"/>English
<form:checkbox path="languagesknown" id="t" value="Telugu"/>Telugu
<form:checkbox path="languagesknown" id="h" value="Hindi"/>Hindi
</td>
<td ><form:errors path="languagesknown" cssClass="error"></form:errors></td></tr>
     <tr><td>Country  :</td>
...
<tr><td>City</td>
<td><form:input path="city" value="${stds.city}"/></td>
<td><form:errors path="city" cssClass="error"></form:errors></td></tr>
<tr><td>Pin code</td>
<td><form:input path="pincode" value="${stds.pincode}"/></td>
<td><form:errors path="pincode" cssClass="error"></form:errors></td></tr>
<tr>
	<td>Address</td>
	<td><form:textarea path="address"  style="width:166px" value="${stds.address}"></form:textarea></td>
