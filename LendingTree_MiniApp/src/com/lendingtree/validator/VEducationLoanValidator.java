...
public class VEducationLoanValidator implements Validator{
...
if(aadhar==null||aadhar=="" ||aadhar.matches("[\\s]+"))
{
   ...
   loan.setAadhaarno(aadhar);
	...
	/*	if(collegead==null||collegead=="" ||collegead.matches("[\\s]+"))
		...
		String lem=loan.getMarksheet();
		if(lem==null||lem=="" ||lem.matches("[\\s]+"))
		{
			errors.rejectValue("marksheet", "marksheet","Last Education Marks Sheet is required");
...
String adp=loan.getAdmisssionproof();
if(adp==null||adp=="" ||adp.matches("[\\s]+"))
{
	errors.rejectValue("admisssionproof", "admisssionproof"," Admission Proof is required");

}
String rc=loan.getRankcopy();
if(rc==null||rc=="" ||rc.matches("[\\s]+"))
{
	errors.rejectValue("rankcopy", "rankcopy"," Rank Copy is required");

}
String sc=loan.getScholarshipcopy();

if(sc==null||sc=="" ||sc.matches("[\\s]+"))
{
	errors.rejectValue("scholarshipcopy", "scholarshipcopy"," Scholarship Copy is required");
